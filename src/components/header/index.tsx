   ...
   const router = useRouter();
    ...
    return (
        <>
                ...
                <div className={pathname === '/menu/Chickens' ? "flex flex-row w-full h-[18vh] bg-chickens justify-center items-center text-white" : `flex flex-row w-full h-[${pathname === '/' ? '21vh' : '18vh'}] bg-caveirito justify-center items-center text-white`}>
