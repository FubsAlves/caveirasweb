...
export default function CategoryCard({name, imageUrl}: any) {
    ...
    return (
        <Link href={`/menu/${name}`} prefetch={true}>
            <div className="flex flex-row w-[48vw] h-[24vh] my-2 rounded-2xl bg-gradient-to-b from-[#B71105] from-50% to-[#FFFFFF] to-50% shadow-md justify-center items-center">
