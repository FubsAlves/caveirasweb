  ...
  return (
      <div className="w-full min-h-[100vh] flex justify-center">
        <div className="w-[90%] rounded-lg min-h-full bg-white flex flex-col items-center text-caveiras italic [&>*]:my-4 [&>*]:w-[80%] md:[&>*]:w-[50%] md:justify-center text-center">
          <h1 className="font-bold text-2xl text-caveirito">História do CB</h1>
          <p>
          ...
          <p>
            Como muitos se modernizaram, decidimos trabalhar apenas com produtos frescos para que a sua experiência em casa seja de estar comendo um lanche de fast food, mas artesanal.
          </p>
          <p>
            {`O intuito do CB nao é apenas captar clientes, mas sim, de gerar amizades, por isso optamos pelo atendimento humanizado. Também queremos além de amigos, grandes fãs da nossa marca, fãs do Caveirito (nosso mascote) e do nosso trabalho.`} 
